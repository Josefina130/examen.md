...
La mano sosteniendo un celular representa el uso de las redes sociales y otras plataformas, donde las personas están expuestas constantemente a imágenes e ideales de belleza. En la pantalla aparecen distintos tonos de piel, algunos marcados con un tick y otros con una equis, evidenciando cómo ciertos rasgos físicos son aceptados y valorados, mientras que otros son rechazados o considerados menos deseables.  
